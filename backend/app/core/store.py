...
class InMemoryStore:
    """Thread-safe projection of PostgreSQL state used by workflow services."""

    def __init__(self, *, load_fixtures: bool = True) -> None:
        self._lock = RLock()
...
store = InMemoryStore(load_fixtures=not settings.production_like)
