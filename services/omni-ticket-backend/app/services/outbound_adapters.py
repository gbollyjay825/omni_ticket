...
class SmtpEmailOutboundAdapter:
    ...
    def _subject(self, context: OutboundSendContext) -> str:
        ...
        subject = context.ticket.subject.strip() or "Omni Ticket update"
        if context.ticket.public_id and context.ticket.public_id not in subject:
            return f"Re: {subject} [{context.ticket.public_id}]"
        return f"Re: {subject}"
    ...
    def _build_message(self, context: OutboundSendContext) -> EmailMessage | None:
        ...
        message["X-Omni-Market-ID"] = context.ticket.market_id
...
class HttpSmsOutboundAdapter:
    ...
    def send(self, context: OutboundSendContext) -> OutboundSendResult:
        ...
        payload: dict[str, Any] = {
            ...
            "public_id": context.ticket.public_id,
