...
| B-112 | Omni parity: expand Admin modules for AI, agents, groups, roles, business hours, portals, email, widgets, phone, chat, feedback form, WhatsApp, ticket forms, automations, email notifications, CSAT surveys, proactive outreach, routing, canned responses, ticket templates, scenario automations, canned forms, tags, threads, and security | P0 | In Progress |
